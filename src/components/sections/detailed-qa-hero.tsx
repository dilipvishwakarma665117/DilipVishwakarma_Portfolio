    ...
    <section className="bg-transparent py-20 md:py-28">
      <div className="container mx-auto px-4 md:px-6">
        <div className="text-center">
          ...
          >
            Detailed Interview <span className="text-[#B89748] italic font-serif font-normal">Answers</span>
          </motion.h1>
          <motion.p
          ...
          >
            <Link href="/qa">
              <Button variant="outline" className="rounded-full px-6 py-2.5 border-slate-200 text-slate-700 hover:text-[#08244C] hover:bg-slate-50">
